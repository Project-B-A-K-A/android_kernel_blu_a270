...
#include <cutils/properties.h> //LINE <EXIF><20130812><make&model auto match> xieqi
...
#define CUSTOM_EXIF_STRING_MODEL "S6041A"
#define CUSTOM_EXIF_STRING_SOFTWARE "S6041A"
static customExifInfo_t exifTag = {CUSTOM_EXIF_STRING_MAKE,CUSTOM_EXIF_STRING_MODEL,CUSTOM_EXIF_STRING_SOFTWARE};
    ...
    return 0;
#else
//BEGIN <EXIF><20130812><make&model auto match> xieqi
#define CUSTOM_EXIF_STRING_MAKE  "TINNO"
...
static customExifInfo_t exifTag = {CUSTOM_EXIF_STRING_MAKE,CUSTOM_EXIF_STRING_MODEL,CUSTOM_EXIF_STRING_SOFTWARE};
    ...
    return 0;
//END <EXIF><20130812><make&model auto match> xieqi
#endif
#else
    return -1;
#endif
...
*******************************************************************************/
#define FLASHLIGHT_CALI_LED_GAIN_PRV_TO_CAP_10X 40 //10
...
*******************************************************************************/
#define FLASHLIGHT_YUV_CONVERGENCE_FRAME 4  //7 //<FLASHLIGHT><20130820><change flashlight frame> xieqi
MINT32 custom_GetYuvFlashlightFrameCnt(void)
{    
    return (int)FLASHLIGHT_YUV_CONVERGENCE_FRAME;
}
//<FLASHLIGHT><20130820><set torch level : 6> xieqi
/*******************************************************************************
* Author : Mingji
...
*******************************************************************************/
#define FLASHLIGHT_YUV_MAIN_HI_TIMEOUT 400 //500
