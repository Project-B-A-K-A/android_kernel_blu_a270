...
const HI704_SENSOR_INIT_INFO HI704_Initial_Setting_Info[] =
{
	...
	{0x70, 0x45},   //For Y decay //48 20130115  
    {0x76, 0x22},
    {0x77, 0x02},   
    {0x78, 0x12},
    {0x79, 0x27},
...
static void HI704_Set_VGA_mode(void)
{
   // HI704_write_cmos_sensor(0x01, HI704_read_cmos_sensor(0x01)|0x01);   //Sleep: For Write Reg
    ...
    HI704_write_cmos_sensor(0x41, 0x05);  
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    spin_unlock(&hi704_yuv_drv_lock);
    HI704_write_cmos_sensor(0x03, 0x10);
    HI704_write_cmos_sensor(0x48, 0x80);  
	CAPTURE_FLAG = 1;
	CAPTUREB_FLAG = 1;
    return ERROR_NONE;
}	/* HM3451Capture() */
...
BOOL HI704_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_AUTO:
       ...
       // HI704_write_cmos_sensor(0x82, 0x38);				
        HI704_write_cmos_sensor(0x83, 0x50);//0x5e
        HI704_write_cmos_sensor(0x84, 0x20);//0x24
        HI704_write_cmos_sensor(0x85, 0x53);//0x5e
        HI704_write_cmos_sensor(0x86, 0x24);//0x24				
        HI704_write_cmos_sensor(0x10, 0xfb);

        HI704_write_cmos_sensor(0x03, 0x00);			
        HI704_write_cmos_sensor(0x50, 0x00);	
    ...
    case AWB_MODE_CLOUDY_DAYLIGHT:
    {
        ...
        HI704_write_cmos_sensor(0x10, 0xfb);
                ...
                HI704_write_cmos_sensor(0x03, 0x00);			
       // HI704_write_cmos_sensor(0x50, 0x01);
        }			   
        break;
...
BOOL HI704_set_param_exposure(UINT16 para)
{
    ...
    case AE_EV_COMP_00:  // +0 EV
        HI704_write_cmos_sensor(0x40,0x83);
        break;    
