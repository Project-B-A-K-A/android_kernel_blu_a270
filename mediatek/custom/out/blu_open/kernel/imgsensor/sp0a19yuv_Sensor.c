...
void SP0A19NightMode(kal_bool bEnable)
{
	...
	{ 
	   ...
	   SP0A19_write_cmos_sensor(0xfd,0x00);
	   SP0A19_write_cmos_sensor(0xb2,0x35);
	...
	else    // daylight mode
	{
		...
		SP0A19_write_cmos_sensor(0xfd,0x00);
		SP0A19_write_cmos_sensor(0xb2,0x30);
		SP0A19_write_cmos_sensor(0xb3,0x1f);
	...
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0x03,0x00);
	SP0A19_write_cmos_sensor(0x04,0xea);//0xe7
	SP0A19_write_cmos_sensor(0x06,0x00);
	SP0A19_write_cmos_sensor(0x09,0x03);
	SP0A19_write_cmos_sensor(0x0a,0x31);// 0x46
	SP0A19_write_cmos_sensor(0xf0,0x4e);// 0x4d
	SP0A19_write_cmos_sensor(0xf1,0x00);
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x90,0x0f);// 0x0e
	SP0A19_write_cmos_sensor(0x92,0x01);
	SP0A19_write_cmos_sensor(0x98,0x4e);// 0x4d
	SP0A19_write_cmos_sensor(0x99,0x00);
	SP0A19_write_cmos_sensor(0x9a,0x01);
	SP0A19_write_cmos_sensor(0x9b,0x00);
	//Status 
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xce,0x92);// 0x36
	SP0A19_write_cmos_sensor(0xcf,0x04);
	SP0A19_write_cmos_sensor(0xd0,0x92);//0x36
	SP0A19_write_cmos_sensor(0xd1,0x04);
	SP0A19_write_cmos_sensor(0xfd,0x00);
...
{  
	...
	//
	SP0A19_write_cmos_sensor(0x57,0x08);  // 0x08
	SP0A19_write_cmos_sensor(0x58,0x0c);// 0x0c
	SP0A19_write_cmos_sensor(0x56,0x0e);
	SP0A19_write_cmos_sensor(0x59,0x12);
	//GrGb
	SP0A19_write_cmos_sensor(0x89,0x08);//0x08
	SP0A19_write_cmos_sensor(0x8a,0x0c);// 0x0c
	SP0A19_write_cmos_sensor(0x9c,0x0e);
	SP0A19_write_cmos_sensor(0x9d,0x12);
	//Gr\Gb
	SP0A19_write_cmos_sensor(0x81,0xe0);
	SP0A19_write_cmos_sensor(0x82,0x40);// 0x80
	SP0A19_write_cmos_sensor(0x83,0x20);// 0x40
	SP0A19_write_cmos_sensor(0x84,0x10);//0x20
	//GrGb
	SP0A19_write_cmos_sensor(0x85,0xe0);
	SP0A19_write_cmos_sensor(0x86,0x40);//0x80
	SP0A19_write_cmos_sensor(0x87,0x20);// 0x40
	SP0A19_write_cmos_sensor(0x88,0x10);// 0x20
	// 
	SP0A19_write_cmos_sensor(0x5a,0xff);
	SP0A19_write_cmos_sensor(0x5b,0x60);// 0xe0
	SP0A19_write_cmos_sensor(0x5c,0x40);// 0x80
	SP0A19_write_cmos_sensor(0x5d,0x10);// 0x20
	...
	SP0A19_write_cmos_sensor(0xe5,0x08);//0x08
	SP0A19_write_cmos_sensor(0xd3,0x08);// 0x08
	SP0A19_write_cmos_sensor(0xd7,0x08);//0x08
	
	SP0A19_write_cmos_sensor(0xe6,0x0a);// 0x0a
	SP0A19_write_cmos_sensor(0xd4,0x0a);//0x0a
	SP0A19_write_cmos_sensor(0xd8,0x0a);//0x0a
	
	SP0A19_write_cmos_sensor(0xe7,0x12);// 0x12
	SP0A19_write_cmos_sensor(0xd5,0x12);// 0x12
	SP0A19_write_cmos_sensor(0xd9,0x12);// 0x12
	
	SP0A19_write_cmos_sensor(0xd2,0x15);//0x15
	SP0A19_write_cmos_sensor(0xd6,0x15);//0x15
	SP0A19_write_cmos_sensor(0xda,0x15);//0x15
   ...
   //CCM
    SP0A19_write_cmos_sensor(0xfd,0x01);                //
	SP0A19_write_cmos_sensor(0xa0,0x72);// 0x6a 0x80    //0x7a
	SP0A19_write_cmos_sensor(0xa1,0x18);                //0x18
	SP0A19_write_cmos_sensor(0xa2,0xf5);// 0x19 0xf6    //0xed
	SP0A19_write_cmos_sensor(0xa3,0xe9);                //0xe9
	SP0A19_write_cmos_sensor(0xa4,0x88);//0x81          //0x8b
	SP0A19_write_cmos_sensor(0xa5,0x0e);//0x0b          //0x0c
	SP0A19_write_cmos_sensor(0xa6,0xd9);// 0xdb         //0xdb
	SP0A19_write_cmos_sensor(0xa7,0x0d);// 0x0d         //0x0d
	SP0A19_write_cmos_sensor(0xa8,0x9a);// 0xa5         //0x9a
	SP0A19_write_cmos_sensor(0xa9,0x30);//0x30          //0x30
	SP0A19_write_cmos_sensor(0xaa,0x03);                //0x03
	SP0A19_write_cmos_sensor(0xab,0x03);//0x03          //0x03
    
    
	//gamma  
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0x8b,0x0 );
	SP0A19_write_cmos_sensor(0x8c,0xC );//0xC
	SP0A19_write_cmos_sensor(0x8d,0x19);// 0x19
	SP0A19_write_cmos_sensor(0x8e,0x2C);// 0x2C
	SP0A19_write_cmos_sensor(0x8f,0x49);// 0x49
	SP0A19_write_cmos_sensor(0x90,0x61);// 0x61
	...
	SP0A19_write_cmos_sensor(0x98,0xD2);//0xD4 
	SP0A19_write_cmos_sensor(0x99,0xDB);//0xDD 
	SP0A19_write_cmos_sensor(0x9a,0xE4);//0xE6 
	SP0A19_write_cmos_sensor(0x9b,0xEA);//0xEF 
	SP0A19_write_cmos_sensor(0xfd,0x01);//0x01 
	SP0A19_write_cmos_sensor(0x8d,0xF1);//0xF7 
	SP0A19_write_cmos_sensor(0x8e,0xF6);//0xFF 
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	//ae min gain  
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x94,0xa0);    //0xa8   modify by sp_yjp,20130913
	SP0A19_write_cmos_sensor(0x95,0x28);
	SP0A19_write_cmos_sensor(0x9c,0xa0);
	SP0A19_write_cmos_sensor(0x9d,0x28);
	//ae target
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xed,0x90);//0xa4
	SP0A19_write_cmos_sensor(0xf7,0x8c);//0xa0
	SP0A19_write_cmos_sensor(0xf8,0x84);//0x98
	SP0A19_write_cmos_sensor(0xec,0x80);//0x94
                                            
	SP0A19_write_cmos_sensor(0xef,0x7c);//0x88
	SP0A19_write_cmos_sensor(0xf9,0x78);//0x84
	SP0A19_write_cmos_sensor(0xfa,0x70);//0x7c
	SP0A19_write_cmos_sensor(0xee,0x6c);//0x78
	...
	//lowlight lum
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xb2,0x30); //0x20 //0x10//modify by sp_yjp,20130913
	SP0A19_write_cmos_sensor(0xb3,0x1f); //0x1f
	
	SP0A19_write_cmos_sensor(0xb4,0x60); //0x70 //0x80  modify by sp_yjp,20130913
	SP0A19_write_cmos_sensor(0xb5,0x80);//0x70  //0x85  modify by sp_yjp,20130913
	...
	SP0A19_write_cmos_sensor(0xd6,0x6c);// 0x78
	SP0A19_write_cmos_sensor(0xd7,0x58);// 0x6c
	
	//HEQ
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xdc,0x00);
	SP0A19_write_cmos_sensor(0xdd,0x7c);    //0x7d  modify by sp_yjp,20130913
	SP0A19_write_cmos_sensor(0xde,0x90);// 0xb0
	SP0A19_write_cmos_sensor(0xdf,0x80);// 0x80
...
void SP0A19_set_saturation(UINT16 para)
{
    switch (para)
    {
        ...
        case ISP_SAT_HIGH:
			...
			SP0A19_write_cmos_sensor(0xd6,0x6c+0x20); //dummy
			SP0A19_write_cmos_sensor(0xd7,0x58+0x20); //low light
             break;
			 
        case ISP_SAT_LOW:
			SP0A19_write_cmos_sensor(0xd3,0x78-0x20); 
			SP0A19_write_cmos_sensor(0xd4,0x78-0x20); 
			SP0A19_write_cmos_sensor(0xd6,0x6c-0x20); 
			SP0A19_write_cmos_sensor(0xd7,0x58-0x20);
             break;
        ...
        default:
			SP0A19_write_cmos_sensor(0xd3,0x78);
			SP0A19_write_cmos_sensor(0xd4,0x78); 
			SP0A19_write_cmos_sensor(0xd6,0x6c); 
			SP0A19_write_cmos_sensor(0xd7,0x58);
             break;
    }
     return;
}
...
void SP0A19_set_contrast(UINT16 para)
{
	...
	switch (para)
	{
		...
		case ISP_CONTRAST_LOW:
			SP0A19_write_cmos_sensor(0xdd,0x7c-0x10); 
			SP0A19_write_cmos_sensor(0xde,0x90-0x20); 
			 break;
		...
		default:
			...
			SP0A19_write_cmos_sensor(0xde,0x90); 
			 break;
	}
    ...
    switch (para)
    {
        ...
        case ISP_BRIGHT_HIGH:
			SP0A19_CurrentStatus.iBrightness = ISP_BRIGHT_HIGH;
			 SP0A19_write_cmos_sensor(0xdc,0x00+0x10); 
             break;
