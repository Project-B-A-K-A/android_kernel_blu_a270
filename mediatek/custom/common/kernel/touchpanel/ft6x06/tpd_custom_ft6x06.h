...
#define TPD_YMAX_NB	        851
#define TPD_YMAX_BYD	    836  //LINE <tp> <DATE20130508> <TP YMAX> zhangxiaofei 
...
*/
#define TPD_KEYS_DIM_NB    {{400, 900, 100, 50},	\
				 			{215, 900, 100, 50},	\
							{80, 900, 100, 50}}

#define TPD_KEYS_DIM_BYD    {{400, 900, 100, 50},	\
				 			{215, 900, 100, 50},	\
							{80, 900, 100, 50}}
